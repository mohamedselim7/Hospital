...
<div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">تواصل معنا</h1>
                <a href="/" class="h4 text-white">الصفحة الرئيسية</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="" class="h4 text-white">احجز الان</a>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-xl-4 col-lg-6 wow slideInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: slideInUp;">
                    <div class="bg-light rounded h-100 p-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>mohamedselim767@gmail.com</span>
                            </div>
                        </div>
                    ...
                    <form method="post" action="/patient">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <input type="text" name="name" id="name" class="form-control border-0 bg-light px-4" placeholder="اسمك" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="integer" name="phone" id="phone" class="form-control border-0 bg-light px-4" placeholder="رقم هاتفك" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="text" name="problem" id="problem" class="form-control border-0 bg-light px-4" placeholder="متي بدأت المكشلة في أسنانك" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea type="text" name="description" id="description" class="form-control border-0 bg-light px-4 py-3" rows="5" placeholder="يرجي وصف حالتك"></textarea>
                            </div>
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit">ارسال حجز</button>
                            </div>
                        </div>
                    </form>
                </div>
